namespace PokemonTextEdition.Classes
{
    ...
    public class PokemonSpecies
    {
        ...
        public PokemonSpecies(int pNumber, string pName, Type pType, Type pType2, string pSpecies, float pCatchRate, int pBaseHP, int pBaseAtk, int pBaseDef, int pBaseSpa, int pBaseSpd, int pBaseSpe)
        {
            Name = pName;
        ...
        public PokemonSpecies(int pNumber, string pName, Type pType, Type pType2, string pSpecies, float pCatchRate, int pBaseHP, int pBaseAtk, int pBaseDef, int pBaseSpa, int pBaseSpd, int pBaseSpe, string pEvolvesInto, int pEvolutionLevel)
        ...
        public PokemonSpecies(int pNumber, string pName, Type pType, Type pType2, string pSpecies, float pCatchRate, int pBaseHP, int pBaseAtk, int pBaseDef, int pBaseSpa, int pBaseSpd, int pBaseSpe, string pEvolvesInto, string pEvolutionType, int pEvolutionLevel)
            : this(pNumber, pName, pType, pType2, pSpecies, pCatchRate, pBaseHP, pBaseAtk, pBaseDef, pBaseSpa, pBaseSpd, pBaseSpe)
        {
