...
namespace PokemonTextEdition.Collections
{
    ...
    class TrainerList
    {
        static public List<Trainer> AllTrainers = new List<Trainer>()
       {
            // 1 - Rival1.cs
           ...
           new Trainer(2, "Bug Catcher", "Nick", 95, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Caterpie", 5), new PokemonGenerator().Create("Caterpie", 5) }),
           ...
           new Trainer(-2, "Bug Catcher", "Nick", 125, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Caterpie", 7), new PokemonGenerator().Create("Caterpie", 8) }),
           ...
           new Trainer(3, "Bug Catcher", "Eric", 85, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Kakuna", 6), new PokemonGenerator().Create("Metapod", 6) }),
           ...
           new Trainer(-3, "Bug Catcher", "Eric", 100, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Kakuna", 8), new PokemonGenerator().Create("Metapod", 8) }),
           ...
           new Trainer(4, "Bug Catcher", "Michael", 110, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Weedle", 9) }),
           ...
           new Trainer(-4, "Bug Catcher", "Michael", 140, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Weedle", 11) }),
           ...
           new Trainer(5, "Camper", "Fred", 180, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Sandshrew", 9) }),
           ...
           new Trainer(6, "Hiker", "Dave", 180, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Diglett", 10) }),
           ...
           new Trainer(-7, "", "Brock", 250, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Geodude", 11), new PokemonGenerator().Create("Onix", 12) }),
           ...
           new Trainer(8, "Youngster", "Lenny", 165, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Rattata", 11), new PokemonGenerator().Create("Ekans", 11) }),
           ...
           new Trainer(-8, "Youngster", "Lenny", 185, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Rattata", 12), new PokemonGenerator().Create("Ekans", 12) }),
           ...
           new Trainer(9, "Youngster", "Timmy", 200, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Spearow", 13) }),
           ...
           new Trainer(-9, "Youngster", "Timmy", 230, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Spearow", 15) }),
           ...
           new Trainer(10, "Lass", "Mina", 150, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Rattata", 12), new PokemonGenerator().Create("Nidoran♂", 12)  }),
           ...
           new Trainer(-10, "Lass", "Mina", 175, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Rattata", 13), new PokemonGenerator().Create("Nidoran♂", 13)  }),
           ...
           new Trainer(11, "Lass", "Mandy", 220, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Jigglypuff", 14)}),
           ...
           new Trainer(-11, "Lass", "Mandy", 240, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Jigglypuff", 16)}),

           new Trainer(12,"Lass", "Lana", 230, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Clefairy", 15)}),
            
           new Trainer(-12, "Lass", "Lana", 270, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Clefairy", 17)}),

           new Trainer(13, "Super Nerd", "Simon", 250, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Magnemite", 11), new PokemonGenerator().Create("Voltorb", 11)}),

           new Trainer(-13, "Super Nerd", "Simon", 270, 
                        ...
                        new List<Pokemon> { new PokemonGenerator().Create("Magnemite", 13), new PokemonGenerator().Create("Voltorb", 13)}),
       };
    }
}
